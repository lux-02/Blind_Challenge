...
export function buildMockReport(blogId: string): BlindReport {
  ...
  const base: BlindReport = {
    ...
    categories,
    phishingSimulation: {
      sms: "[예약도움센터] 지난 [강남역 매장] 모임 확인이 누락되어 일정이 보류되었습니다. 오늘 안으로 담당자 성함만 회신 주시면 바로 처리 가능합니다. (훈련용 시뮬레이션)",
      voiceScript:
        [
          "공격자: 안녕하세요, [예약도움센터]입니다. 지난 [강남역 매장] 단체 일정 확인 건으로 연락드렸습니다.",
          "사용자: 어떤 건인지 잘 모르겠는데요.",
          "공격자: [지인] 포함 3인 모임으로 등록되어 있는데 담당자 확인이 빠져 오늘 마감 처리에서 보류되었습니다.",
          "사용자: 어떤 확인이 필요한가요?",
          "공격자: 간단히 성함과 모임 관계만 확인되면 바로 복구 가능합니다.",
          "사용자: 지금 바로 말해야 하나요?",
          "공격자: 네, 오늘 안에 정리하지 않으면 다음 일정으로 자동 이월될 수 있습니다.",
          "사용자: 문자를 따로 받을 수 있나요?",
          "공격자: 가능합니다. 안내 문구 보내드리면 확인 답장만 부탁드립니다.",
          "사용자: 알겠습니다.",
          "공격자: [훈련 안내] 실제 통화에서는 즉시 답하지 말고, 끊은 뒤 해당 서비스의 공식 앱에서 직접 확인하세요.",
        ].join("\n"),
      model: "sample",
      generatedAt: MOCK_NOW_ISO,
    },
